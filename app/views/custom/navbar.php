<header>
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light text-white">
            <a class="navbar-brand" href="<?php echo URL_PROJECT ?>/home/"><img src="<?php echo URL_PROJECT?>/public/img/tesh.png" alt="Logo" class="image-logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo URL_PROJECT ?>/home/"><span class="big"><i class="fas fa-landmark"></i></span> Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo URL_PROJECT ?>/home/usuarios"><span class="big"><i class="fas fa-user-friends"></i></span> Usuarios</a>
                    </li>
                    <li class="nav-item">
